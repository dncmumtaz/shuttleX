...
export default function DriverDashboardLayout() {
  ...
  const navItems = [
    ...
    { to: '/driver/requests', label: t('nav.pendingRequests'), icon: '📋' },

    { to: '/driver/vehicle-settings', label: t('nav.vehicleSettings'), icon: '🚗' },

    { to: '/driver/vehicle-services', label: t('nav.vehicleServices'), icon: '🚐' },

    { to: '/driver/trips', label: t('nav.driverTrips'), icon: '🚌' },
  ...
  return (
    ...
    <div className="dashboard-root d-flex min-vh-100">

      <aside className="dashboard-sidebar driver-sidebar bg-dark text-white d-flex flex-column">

        <div className="sidebar-brand px-4 py-4 border-bottom border-secondary">

          <h1 className="h4 mb-0 fw-bold">ShuttleX</h1>

          <small className="text-secondary">{t('nav.driverPanel')}</small>
      ...
      <div className="dashboard-main flex-grow-1 d-flex flex-column">
        ...
        <header className="dashboard-header bg-white border-bottom px-4 py-3 d-flex align-items-center justify-content-between">
          ...
          <div>
            ...
            <small className="text-muted">{t('nav.driverSubtitle')}</small>
